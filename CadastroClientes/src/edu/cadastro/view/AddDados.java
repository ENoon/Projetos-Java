...
import edu.cadastro.controller.AddDadosController;
import java.sql.SQLException;
import java.util.logging.Level;
import java.util.logging.Logger;
import javax.swing.JTextField;

public class AddDados extends javax.swing.JFrame {

    private final AddDadosController controller;
    
    public AddDados() {
        initComponents();
        controller = new AddDadosController(this);
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddDados.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
